  ...
  template:
    ...
    spec:
      ...
      - name: kubedns
        ...
        image: docker.io/gnosoir/kube-dns:1.14.10
      ...
      - name: dnsmasq
        ...
        image: docker.io/gnosoir/dnsmasq-nanny:1.14.10
        imagePullPolicy: IfNotPresent
        livenessProbe:
          httpGet:
      ...
      - name: sidecar
        ...
        image: docker.io/gnosoir/sidecar-amd64:1.14.10
        imagePullPolicy: IfNotPresent
        livenessProbe:
          httpGet:
            path: /metrics
        ...
        - --v=2
        - --logtostderr
        - --probe=kubedns,127.0.0.1:10053,kubernetes.default.svc.$CLUSTER_DNS_DOMAIN,5,SRV
        - --probe=dnsmasq,127.0.0.1:53,kubernetes.default.svc.$CLUSTER_DNS_DOMAIN,5,SRV
        ports:
        - containerPort: 10054
          name: metrics
          protocol: TCP
